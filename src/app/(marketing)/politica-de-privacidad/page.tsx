  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16">
      ...
      <div className="flex flex-col gap-5 text-sm leading-relaxed text-zinc-400">
        ...
        <div>
          <h2 className="mb-1 font-semibold text-zinc-200">1. Datos que recopilamos</h2>
          <p>
        ...
        <div>
          <h2 className="mb-1 font-semibold text-zinc-200">2. Finalidad</h2>
        ...
        <div>
          <h2 className="mb-1 font-semibold text-zinc-200">3. Certificados y credenciales SUNAT/pasarela de pago</h2>
          <p>
        ...
        <div>
          <h2 className="mb-1 font-semibold text-zinc-200">4. No divulgación a terceros</h2>
          <p>
        ...
        <div>
          <h2 className="mb-1 font-semibold text-zinc-200">5. Derechos ARCO</h2>
          <p>
